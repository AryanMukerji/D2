...
center_helper<charT, traits> centered1(std::basic_string<charT, traits> str) 
{
    return center_helper<charT, traits>(str);
}

// redeclare for std::string directly so we can support anything that implicitly converts to std::string
center_helper<std::string::value_type, std::string::traits_type> centered1(const std::string& str) 
{
...
void display_PostList()
{
	...
	cout << "\n\n";
	cout << "+" << std::setw(40) << centered1(" -------------------------------------- ")
		 << "+" << std::setw(40) << centered1(" -------------------------------------- ")
		 << "+" << std::setw(40) << centered1(" -------------------------------------- ") 
		 << "+" << std::setw(40) << centered1(" -------------------------------------- ") 
		 << "+" << std::endl;
	
	cout << "|" << std::setw(40) << centered1(" Post ID ")
		 << "|" << std::setw(40) << centered1(" Post Name ")
         << "|" << std::setw(40) << centered1(" Amount Required ")
		 << "|" << std::setw(40) << centered1(" Amount Left ")
		 << "|" << std::endl;
    ...
    {
		cout << "|" << std::setw(40) << centered1(to_string(PostList[i].get_Post_ID()))
		 << "|" << std::setw(40) << centered1(PostList[i].get_Post_Title())
         << "|" << std::setw(40) << centered1(to_string(PostList[i].get_amount_requested()))
		 << "|" << std::setw(40) << centered1(to_string(PostList[i].get_amount_left()))
		 << "|" << std::endl;
